-- Create VmScalingActivityLog table (idempotent)
...
BEGIN
    ...
    PRINT 'Table VmScalingActivityLog created successfully.';
END
ELSE
    PRINT 'Table VmScalingActivityLog already exists. Skipping creation.';
GO
